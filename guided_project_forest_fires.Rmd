...
The graphs above have two high extreme values with large hectares burned, which obscures the relationship between index values and the distribution of smaller hectares burned.
